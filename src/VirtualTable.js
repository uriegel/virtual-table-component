...
export class VirtualTable extends HTMLElement {
    ...
    connectedCallback() {
        ...
        this.tableHeadRow.addEventListener("mousemove", evt => this.onMouseMoveOnHead(evt))
        this.tableHeadRow.addEventListener("mousedown", evt => this.onMouseDownOnHead(evt))
